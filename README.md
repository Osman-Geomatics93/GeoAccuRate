...
- **Confusion matrix** for any number of classes with OA, PA, UA, F1, and Wilson confidence intervals
...
- **PDF reports** with tables, charts, auto-generated methods text, and proper citations
...
1. Download the latest release ZIP from [Releases](https://github.com/geoaccurate/geoaccurate-qgis/releases)
...
- **ReportLab** (for PDF reports): `pip install reportlab` in QGIS Python console
...
80 unit tests covering confusion matrix, Pontius, Olofsson, Wilson CI, Kappa, sampling, and edge cases.
